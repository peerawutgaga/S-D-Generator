<?php
    ...
    // $conn->close();
    SourceCodeGenerator::createSourceCode(1,1,'gzxIJfqGAqACJQew','test2','driver','Java');
    // SourceCodeGenerator::createSourceCode(1,1,'54hIJfqGAqACJQeg','test3','driver','Java');
    SourceCodeGenerator::createSourceCode(1,1,'hCd5JfqGAqACJQiu','test4','driver','Java');
